...
public class Program
{
    ...
    [Test]
    [AocData("Week3/Day16Example1.txt", part1: 7036, part2: 45)]
    [AocData("Week3/Day16Example2.txt", part1: 11048, part2: 64)]
    [AocData("Week3/Day16.txt", part1: 143564, part2: 593)]
    public void Day16Tests(AocData data) => AocTester.Test<Day16>(data);

    [Test]
    [AocData("Week3/Day17Example1.txt", part1: "4,6,3,5,6,3,5,2,1,0")]
    [AocData("Week3/Day17Example2.txt", part2: 117440)]
    [AocData("Week3/Day17.txt", part1: "4,3,7,1,5,3,0,5,4", part2: "1")]
    public void Day17Tests(AocData data) => AocTester.Test<Day17>(data);

    [Test]
    [AocData("Week3/Day18Example.txt", part1: 22, part2: "6,1")]
    [AocData("Week3/Day18.txt", part1: 436, part2: "61,50")]
    public void Day18Tests(AocData data) => AocTester.Test<Day18>(data);

    [Test]
    [AocData("Week3/Day19Example.txt", part1: 6, part2: 16)]
    [AocData("Week3/Day19.txt", part1: 353, part2: 880877787214477L)]
    public void Day19Tests(AocData data) => AocTester.Test<Day19>(data);

    [Test]
    [AocData("Week3/Day20.txt", part1: 1343, part2: 982891)]
    public void Day20Tests(AocData data) => AocTester.Test<Day20>(data);

    [Test]
    [AocData("Week3/Day21Example.txt", part1: 126384, part2: 154115708116294L)]
    [AocData("Week3/Day21.txt", part1: 203734, part2: 246810588779586L)]
    public void Day21Tests(AocData data) => AocTester.Test<Day21>(data);

    [Test]
    [AocData("Week4/Day22Example1.txt", part1: 37327623)]
    [AocData("Week4/Day22Example2.txt", part2: 23)]
    [AocData("Week4/Day22.txt", part1: 13429191512L, part2: 1582)]
    public void Day22Tests(AocData data) => AocTester.Test<Day22>(data);

    [Test]
    [AocData("Week4/Day23Example.txt", part1: 7, part2: "co,de,ka,ta")]
    [AocData("Week4/Day23.txt", part1: 1348, part2: "am,bv,ea,gh,is,iy,ml,nj,nl,no,om,tj,yv")]
